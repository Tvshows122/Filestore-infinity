...
from info import CHANNELS, ADMINS, AUTH_CHANNEL, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT, API_LINK
        ...
        for msg in msgs:
            ...
            try:
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton("Dev Channel", url="https://t.me/white_dEvil_Bots")] ] ),
...
async def restart(Client, Message):
    sleep(3)
    await Message.reply("Reboot started !")
    exit(0)
