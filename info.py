...
API_LINK=str(environ.get('API_LINK',''))
FSUB_UPDATE_LINK=str(environ.get('FSUB_UPDATE_LINK',''))
# Bot settings
...
DATABASE_NAME = environ.get('DATABASE_NAME', "wdBots")
...
if FSUB_UPDATE_LINK:
    try:
        REQ_CHANNEL=urlopen(FSUB_UPDATE_LINK).read().decode('utf-8')
        print(REQ_CHANNEL)
    except:
        REQ_CHANNEL=-1001818707519
else:
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'wD_Support')
